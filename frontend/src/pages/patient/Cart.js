...
function Cart() {
  ...
  return (
    <div>
      ...
      {items.length === 0 ? (
        <p className="feature-card">Cart is empty</p>
      ) : (
        <>
          ...
          <h3 className="feature-card">Total: ${totalPrice.toFixed(2)}</h3>
          <div className='buy-container'><button className="buy-btn" onClick={() => navigate('/patient/checkout')}>
            Buy Items
          </button></div>
